...
export class MimeTypeResolver {
    ...
    public static definitions : MimeTypeDefinition[] = [
        {
            fileExtensions: ['.aac'],
            mimeType: 'audio/aac',
    ...
    public static unknownDefinition : MimeTypeDefinition = {
        fileExtensions : [''],
        mimeType : 'application/octet-stream',
    ...
    public static resolveMimeType(filename : string) : string {
        // Extract the file extension from the filename
        let fileExtensionStartIndex : number = filename.lastIndexOf('.');
        if (fileExtensionStartIndex == -1) { return MimeTypeResolver.unknownDefinition.mimeType; }

        let fileExtension : string = filename.substr(fileExtensionStartIndex).toLowerCase();

        // Search the known definitions for the file extension
        let discoveredMimeTypeIndex : number = MimeTypeResolver.definitions.findIndex(
            (value,index,list) => {
