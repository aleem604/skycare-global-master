...
let LoginAttemptRepository = class LoginAttemptRepository extends repository_1.DefaultCrudRepository {
    constructor(dataSource) {
        super(models_1.LoginAttempt, dataSource);
    }
};
LoginAttemptRepository = __decorate([
